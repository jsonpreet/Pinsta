...
export const DEFAULT_SEO = {
  title: "Pinsta",
  description:
    "Pinsta is a decentralized Image & Video Sharing service, designed to save and collect discovery information using Images, Videos, and Animated Gifs in the form of Pin Boards.",
...
export const PINSTA_SERVER_URL = IS_MAINNET
  ? "https://server.pinsta.xyz"
  : "https://testnet-server.pinsta.xyz";
