...
const PreviewList: FC<Props> = ({ className, selectedConversationKey }) => {
  ...
  const [getProfiles, { data: searchResults, loading: searchLoading }] =
        ...
        <div className="w-full px-4 pt-4">
          ...
          >
            ...
            <div className="absolute inset-y-0 left-0 flex items-center pl-4">
              <BsSearch className="w-4 h-4 text-gray-600" aria-hidden="true" />
            </div>
          </div>
        </div>
        {searchLoading && (
        ...
        {showResults && (
          <div className="w-full py-4">
            <div className="flex flex-col divide-y dark:divide-gray-700">
              {searchResults?.search?.__typename === "ProfileSearchResult" &&
