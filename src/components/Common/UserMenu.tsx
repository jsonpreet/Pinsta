...
import { BsChevronLeft, BsGear, BsMoon, BsPersonCircle, BsPlusCircle, BsShuffle, BsSun, BsPower } from "react-icons/bs";
...
const UserMenu = () => {
  ...
  const currentProfile = useAppStore(
    (state) => state.currentProfile as Profile
  )
  ...
  return (
    ...
    >
      <div className="px-1 mt-1.5 w-48 divide-y shadow max-h-96 divide-gray-200 dark:divide-gray-800 overflow-hidden border border-gray-100 rounded-xl dark:border-gray-800 bg-white">
        {showAccountSwitcher ? (
          <>
            <button
              type="button"
