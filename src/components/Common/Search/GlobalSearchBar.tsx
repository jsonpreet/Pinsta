        ...
        <div className="w-full">
            <div ref={resultsRef}>
                <div className="relative">
                    <div className="relative w-full overflow-hidden border border-gray-300 cursor-default dark:border-gray-700 bg-gray-100 dark:bg-gray-800 rounded-full sm:text-sm">
                        <input
                    ...
                    <div
                        className={clsx(
                        'md:absolute w-full z-10 mt-1 text-base bg-white dark:bg-gray-800 overflow-hidden dark:bg-theme md:rounded-xl md:ring-1 md:ring-black md:ring-opacity-5 focus:outline-none sm:text-sm',
